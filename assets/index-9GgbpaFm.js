...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function Ip(i,e,t){const n=new Float32Array(ni),s=new U(0,1,0);return new bt({name:"SphericalGaussianBlur",defines:{n:ni,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function fl(){return new bt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function pl(){return new bt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pr(),fragmentShader:`
	...
	`}class Tc extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Mc(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new hs(5,5,5),r=new bt({name:"CubemapFromEquirect",uniforms:Bi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:It,blending:hn});r.uniforms.tEquirect.value=t;const a=new wt(s,r),o=t.minFilter;return t.minFilter===ii&&(t.minFilter=Dt),new Uh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function Np(i){let e=new WeakMap,t=new WeakMap,n=null;function s(u,f=!1){return u==null?null:f?a(u):r(u)}function r(u){if(u&&u.isTexture){const f=u.mapping;if(f===Mr||f===Sr)if(e.has(u)){const g=e.get(u).texture;return o(g,u.mapping)}else{const g=u.image;if(g&&g.height>0){const M=new Tc(g.height);return M.fromEquirectangularTexture(i,u),e.set(u,M),u.addEventListener("dispose",l),o(M.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const f=u.mapping,g=f===Mr||f===Sr,M=f===ri||f===Ui;if(g||M){let m=t.get(u);const p=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return n===null&&(n=new hl(i)),m=g?n.fromEquirectangular(u,m):n.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const S=u.image;return g&&S&&S.height>0||M&&S&&c(S)?(n===null&&(n=new hl(i)),m=g?n.fromEquirectangular(u):n.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",d),m.texture):null}}}return u}function o(u,f){return f===Mr?u.mapping=ri:f===Sr&&(u.mapping=Ui),u}function c(u){let f=0;const g=6;for(let M=0;M<g;M++)u[M]!==void 0&&f++;return f===g}function l(u){const f=u.target;f.removeEventListener("dispose",l);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function d(u){const f=u.target;f.removeEventListener("dispose",d);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function h(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:h}}function Up(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&sr("WebGLRenderer: "+n+" extension not supported."),s}}}function Fp(i,e,t,n){const s={},r=new WeakMap;function a(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",a),delete s[u.id];const f=r.get(u);f&&(e.remove(f),r.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(h,u){return s[u.id]===!0||(u.addEventListener("dispose",a),s[u.id]=!0,t.memory.geometries++),u}function c(h){const u=h.attributes;for(const f in u)e.update(u[f],i.ARRAY_BUFFER)}function l(h){const u=[],f=h.index,g=h.attributes.position;let M=0;if(g===void 0)return;if(f!==null){const S=f.array;M=f.version;for(let T=0,y=S.length;T<y;T+=3){const R=S[T+0],A=S[T+1],P=S[T+2];u.push(R,A,A,P,P,R)}}else{const S=g.array;M=g.version;for(let T=0,y=S.length/3-1;T<y;T+=3){const R=T+0,A=T+1,P=T+2;u.push(R,A,A,P,P,R)}}const m=new(g.count>=65535?vc:_c)(u,1);m.version=M;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function d(h){const u=r.get(h);if(u){const f=h.index;f!==null&&u.version<f.version&&l(h)}else l(h);return r.get(h)}return{get:o,update:c,getWireframeAttribute:d}}function Op(i,e,t){let n;function s(u){n=u}let r,a;function o(u){r=u.type,a=u.bytesPerElement}function c(u,f){i.drawElements(n,f,r,u*a),t.update(f,n,1)}function l(u,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,u*a,g),t.update(f,n,g))}function d(u,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,u,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function h(u,f,g,M){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<u.length;p++)l(u[p]/a,f[p],M[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,u,0,M,0,g);let p=0;for(let S=0;S<g;S++)p+=f[S]*M[S];t.update(p,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=h}function Bp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:We("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function zp(i,e,t){const n=new WeakMap,s=new ft;function r(a,o,c){const l=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=d!==void 0?d.length:0;let u=n.get(o);if(u===void 0||u.count!==h){let q=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",q)};var f=q;u!==void 0&&u.texture.dispose();const g=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let y=0;g===!0&&(y=1),M===!0&&(y=2),m===!0&&(y=3);let R=o.attributes.position.count*y,A=1;R>e.maxTextureSize&&(A=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const P=new Float32Array(R*A*4*h),v=new mc(P,R,A,h);v.type=ln,v.needsUpdate=!0;const b=y*4;for(let C=0;C<h;C++){const H=p[C],G=S[C],W=T[C],D=R*A*4*C;for(let O=0;O<H.count;O++){const N=O*b;g===!0&&(s.fromBufferAttribute(H,O),P[D+N+0]=s.x,P[D+N+1]=s.y,P[D+N+2]=s.z,P[D+N+3]=0),M===!0&&(s.fromBufferAttribute(G,O),P[D+N+4]=s.x,P[D+N+5]=s.y,P[D+N+6]=s.z,P[D+N+7]=0),m===!0&&(s.fromBufferAttribute(W,O),P[D+N+8]=s.x,P[D+N+9]=s.y,P[D+N+10]=s.z,P[D+N+11]=W.itemSize===4?s.w:1)}}u={count:h,texture:v,size:new Ae(R,A)},n.set(o,u),o.addEventListener("dispose",q)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const M=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",M),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:r}}function Hp(i,e,t,n,s){let r=new WeakMap;function a(l){const d=s.render.frame,h=l.geometry,u=e.get(l,h);if(r.get(u)!==d&&(e.update(u),r.set(u,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==d&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,d))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==d&&(f.update(),r.set(f,d))}return u}function o(){r=new WeakMap}function c(l){const d=l.target;d.removeEventListener("dispose",c),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const Gp={[Ql]:"LINEAR_TONE_MAPPING",[ec]:"REINHARD_TONE_MAPPING",[tc]:"CINEON_TONE_MAPPING",[nc]:"ACES_FILMIC_TONE_MAPPING",[sc]:"AGX_TONE_MAPPING",[rc]:"NEUTRAL_TONE_MAPPING",[ic]:"CUSTOM_TONE_MAPPING"};function Vp(i,e,t,n,s){const r=new Gt(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new Gt(e,t,{type:qt,depthBuffer:!1,stencilBuffer:!1}),o=new Ct;o.setAttribute("position",new Ut([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Ut([0,2,0,0,2,0],2));const c=new wh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new wt(o,c),d=new vo(-1,1,1,-1,0,1);let h=null,u=null,f=!1,g,M=null,m=[],p=!1;this.setSize=function(S,T){r.setSize(S,T),a.setSize(S,T);for(let y=0;y<m.length;y++){const R=m[y];R.setSize&&R.setSize(S,T)}},this.setEffects=function(S){m=S,p=m.length>0&&m[0].isRenderPass===!0;const T=r.width,y=r.height;for(let R=0;R<m.length;R++){const A=m[R];A.setSize&&A.setSize(T,y)}},this.begin=function(S,T){if(f||S.toneMapping===dn&&m.length===0)return!1;if(M=T,T!==null){const y=T.width,R=T.height;(r.width!==y||r.height!==R)&&this.setSize(y,R)}return p===!1&&S.setRenderTarget(r),g=S.toneMapping,S.toneMapping=dn,!0},this.hasRenderPass=function(){return p},this.end=function(S,T){S.toneMapping=g,f=!0;let y=r,R=a;for(let A=0;A<m.length;A++){const P=m[A];if(P.enabled!==!1&&(P.render(S,R,y,T),P.needsSwap!==!1)){const v=y;y=R,R=v}}if(h!==S.outputColorSpace||u!==S.toneMapping){h=S.outputColorSpace,u=S.toneMapping,c.defines={},Xe.getTransfer(h)===Ze&&(c.defines.SRGB_TRANSFER="");const A=Gp[u];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=y.texture,S.setRenderTarget(M),S.render(l,d),M=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),c.dispose()}}const Ac=new At,Qa=new rs(1,1),Cc=new mc,wc=new eh,Rc=new Mc,ml=[],gl=[],_l=new Float32Array(16),vl=new Float32Array(9),xl=new Float32Array(4);function Gi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=ml[s];if(r===void 0&&(r=new Float32Array(s),ml[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function vt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function xt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function mr(i,e){let t=gl[e];t===void 0&&(t=new Int32Array(e),gl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function kp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Wp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2fv(this.addr,e),xt(t,e)}}function Xp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;i.uniform3fv(this.addr,e),xt(t,e)}}function qp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4fv(this.addr,e),xt(t,e)}}function Yp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;xl.set(n),i.uniformMatrix2fv(this.addr,!1,xl),xt(t,n)}}function $p(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;vl.set(n),i.uniformMatrix3fv(this.addr,!1,vl),xt(t,n)}}function Kp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),xt(t,e)}else{if(vt(t,n))return;_l.set(n),i.uniformMatrix4fv(this.addr,!1,_l),xt(t,n)}}function jp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2iv(this.addr,e),xt(t,e)}}function Jp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3iv(this.addr,e),xt(t,e)}}function Qp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4iv(this.addr,e),xt(t,e)}}function em(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function tm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2uiv(this.addr,e),xt(t,e)}}function nm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3uiv(this.addr,e),xt(t,e)}}function im(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4uiv(this.addr,e),xt(t,e)}}function sm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Qa.compareFunction=t.isReversedDepthBuffer()?po:fo,r=Qa):r=Ac,t.setTexture2D(e||r,s)}function rm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||wc,s)}function am(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Rc,s)}function om(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Cc,s)}function lm(i){switch(i){case 5126:return kp;case 35664:return Wp;case 35665:return Xp;case 35666:return qp;case 35674:return Yp;case 35675:return $p;case 35676:return Kp;case 5124:case 35670:return jp;case 35667:case 35671:return Zp;case 35668:case 35672:return Jp;case 35669:case 35673:return Qp;case 5125:return em;case 36294:return tm;case 36295:return nm;case 36296:return im;case 35678:case 36198:case 36298:case 36306:case 35682:return sm;case 35679:case 36299:case 36307:return rm;case 35680:case 36300:case 36308:case 36293:return am;case 36289:case 36303:case 36311:case 36292:return om}}function cm(i,e){i.uniform1fv(this.addr,e)}function um(i,e){const t=Gi(e,this.size,2);i.uniform2fv(this.addr,t)}function hm(i,e){const t=Gi(e,this.size,3);i.uniform3fv(this.addr,t)}function dm(i,e){const t=Gi(e,this.size,4);i.uniform4fv(this.addr,t)}function fm(i,e){const t=Gi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function pm(i,e){const t=Gi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function mm(i,e){const t=Gi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function gm(i,e){i.uniform1iv(this.addr,e)}function _m(i,e){i.uniform2iv(this.addr,e)}function vm(i,e){i.uniform3iv(this.addr,e)}function xm(i,e){i.uniform4iv(this.addr,e)}function Mm(i,e){i.uniform1uiv(this.addr,e)}function Sm(i,e){i.uniform2uiv(this.addr,e)}function Em(i,e){i.uniform3uiv(this.addr,e)}function bm(i,e){i.uniform4uiv(this.addr,e)}function ym(i,e,t){const n=this.cache,s=e.length,r=mr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=Qa:a=Ac;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function Tm(i,e,t){const n=this.cache,s=e.length,r=mr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||wc,r[a])}function Am(i,e,t){const n=this.cache,s=e.length,r=mr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Rc,r[a])}function Cm(i,e,t){const n=this.cache,s=e.length,r=mr(t,s);vt(n,r)||(i.uniform1iv(this.addr,r),xt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Cc,r[a])}function wm(i){switch(i){case 5126:return cm;case 35664:return um;case 35665:return hm;case 35666:return dm;case 35674:return fm;case 35675:return pm;case 35676:return mm;case 5124:case 35670:return gm;case 35667:case 35671:return _m;case 35668:case 35672:return vm;case 35669:case 35673:return xm;case 5125:return Mm;case 36294:return Sm;case 36295:return Em;case 36296:return bm;case 35678:case 36198:case 36298:case 36306:case 35682:return ym;case 35679:case 36299:case 36307:return Tm;case 35680:case 36300:case 36308:case 36293:return Am;case 36289:case 36303:case 36311:case 36292:return Cm}}class Rm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=lm(t.type)}}class Pm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=wm(t.type)}}class Lm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Qr=/(\w+)(\])?(\[|\.)?/g;function Ml(i,e){i.seq.push(e),i.map[e.id]=e}function Dm(i,e,t){const n=i.name,s=n.length;for(Qr.lastIndex=0;;){const r=Qr.exec(n),a=Qr.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Ml(t,l===void 0?new Rm(o,i,e):new Pm(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new Lm(o),Ml(t,h)),t=h}}}class Ks{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);Dm(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Sl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Im=37297;let Nm=0;function Um(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const El=new Oe;function Fm(i){Xe._getMatrix(El,Xe.workingColorSpace,i);const e=`mat3( ${El.elements.map(t=>t.toFixed(4))} )`;switch(Xe.getTransfer(i)){case nr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Pe("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function bl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+Um(i.getShaderSource(e),o)}else return r}function Om(i,e){const t=Fm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Bm={[Ql]:"Linear",[ec]:"Reinhard",[tc]:"Cineon",[nc]:"ACESFilmic",[sc]:"AgX",[rc]:"Neutral",[ic]:"Custom"};function zm(i,e){const t=Bm[e];return t===void 0?(Pe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const zs=new U;function Hm(){Xe.getLuminanceCoefficients(zs);const i=zs.x.toFixed(4),e=zs.y.toFixed(4),t=zs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function km(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Zi(i){return i!==""}function yl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Tl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Wm=/^[ \t]*#include +<([\w\d./]+)>/gm;function eo(i){return i.replace(Wm,qm)}const Xm=new Map;function qm(i,e){let t=Be[e];if(t===void 0){const n=Xm.get(e);if(n!==void 0)t=Be[n],Pe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return eo(t)}const Ym=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Al(i){return i.replace(Ym,$m)}function $m(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Cl(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const Km={[ks]:"SHADOWMAP_TYPE_PCF",[ji]:"SHADOWMAP_TYPE_VSM"};function jm(i){return Km[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Zm={[ri]:"ENVMAP_TYPE_CUBE",[Ui]:"ENVMAP_TYPE_CUBE",[ur]:"ENVMAP_TYPE_CUBE_UV"};function Jm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Zm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Qm={[Ui]:"ENVMAP_MODE_REFRACTION"};function eg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Qm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const tg={[Jl]:"ENVMAP_BLENDING_MULTIPLY",[Lu]:"ENVMAP_BLENDING_MIX",[Du]:"ENVMAP_BLENDING_ADD"};function ng(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":tg[i.combine]||"ENVMAP_BLENDING_NONE"}function ig(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function sg(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=jm(t),l=Jm(t),d=eg(t),h=ng(t),u=ig(t),f=Gm(t),g=Vm(r),M=s.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const T=S+m+a,y=S+p+o,R=Sl(s,s.VERTEX_SHADER,T),A=Sl(s,s.FRAGMENT_SHADER,y);s.attachShader(M,R),s.attachShader(M,A),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function P(C){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(M)||"",G=s.getShaderInfoLog(R)||"",W=s.getShaderInfoLog(A)||"",D=H.trim(),O=G.trim(),N=W.trim();let Z=!0,j=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,R,A);else{const oe=bl(s,R,"vertex"),de=bl(s,A,"fragment");We("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class ds{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const jg=new vo(-1,1,1,-1,0,1);class Zg extends Ct{constructor(){super(),this.setAttribute("position",new Ut([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Ut([0,2,0,0,2,0],2))}}const Jg=new Zg;class Lc{constructor(e){this._mesh=new wt(Jg,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,jg)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Dc extends ds{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof bt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=or.clone(e.uniforms),this.material=new bt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Lc(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class Nl extends ds{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class Qg extends ds{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class e_{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Ae);this._width=n.width,this._height=n.height,t=new Gt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:qt}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Dc(js),this.copyPass.material.blending=hn,this.timer=new Oh}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Nl!==void 0&&(a instanceof Nl?n=!0:a instanceof Qg&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Ae);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class t_ extends ds{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Ne}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const n_={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ne(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}zi.BlurDirectionX=new Ae(1,0);zi.BlurDirectionY=new Ae(0,1);function i_(i){return i}function s_(i){if(i==null)return i_;var e,t,n=i.scale[0],s=i.scale[1],r=i.translate[0],a=i.translate[1];return function(o,c){c||(e=t=0);var l=2,d=o.length,h=new Array(d);for(h[0]=(e+=o[0])*n+r,h[1]=(t+=o[1])*s+a;l<d;)h[l]=o[l],++l;return h}}function r_(i,e){for(var t,n=i.length,s=n-e;s<--n;)t=i[s],i[s++]=i[n],i[n]=t}function a_(i,e){return typeof e=="string"&&(e=i.objects[e]),e.type==="GeometryCollection"?{type:"FeatureCollection",features:e.geometries.map(function(t){return Ul(i,t)})}:Ul(i,e)}function Ul(i,e){var t=e.id,n=e.bbox,s=e.properties==null?{}:e.properties,r=Ic(i,e);return t==null&&n==null?{type:"Feature",properties:s,geometry:r}:n==null?{type:"Feature",id:t,properties:s,geometry:r}:{type:"Feature",id:t,bbox:n,properties:s,geometry:r}}function Ic(i,e){var t=s_(i.transform),n=i.arcs;function s(d,h){h.length&&h.pop();for(var u=n[d<0?~d:d],f=0,g=u.length;f<g;++f)h.push(t(u[f],f));d<0&&r_(h,g)}function r(d){return t(d)}function a(d){for(var h=[],u=0,f=d.length;u<f;++u)s(d[u],h);return h.length<2&&h.push(h[0]),h}function o(d){for(var h=a(d);h.length<4;)h.push(h[0]);return h}function c(d){return d.map(o)}function l(d){var h=d.type,u;switch(h){case"GeometryCollection":return{type:h,geometries:d.geometries.map(l)};case"Point":u=r(d.coordinates);break;case"MultiPoint":u=d.coordinates.map(r);break;case"LineString":u=a(d.arcs);break;case"MultiLineString":u=d.arcs.map(a);break;case"Polygon":u=c(d.arcs);break;case"MultiPolygon":u=d.arcs.map(c);break;default:return null}return{type:h,coordinates:u}}return l(e)}function o_(i,e){var t={},n={},s={},r=[],a=-1;e.forEach(function(l,d){var h=i.arcs[l<0?~l:l],u;h.length<3&&!h[1][0]&&!h[1][1]&&(u=e[++a],e[a]=l,e[d]=u)}),e.forEach(function(l){var d=o(l),h=d[0],u=d[1],f,g;if(f=s[h])if(delete s[f.end],f.push(l),f.end=u,g=n[u]){delete n[g.start];var M=g===f?f:f.concat(g);n[M.start=f.start]=s[M.end=g.end]=M}else n[f.start]=s[f.end]=f;else if(f=n[u])if(delete n[f.start],f.unshift(l),f.start=h,g=s[h]){delete s[g.end];var m=g===f?f:g.concat(f);n[m.start=g.start]=s[m.end=f.end]=m}else n[f.start]=s[f.end]=f;else f=[l],n[f.start=h]=s[f.end=u]=f});function o(l){var d=i.arcs[l<0?~l:l],h=d[0],u;return i.transform?(u=[0,0],d.forEach(function(f){u[0]+=f[0],u[1]+=f[1]})):u=d[d.length-1],l<0?[u,h]:[h,u]}function c(l,d){for(var h in l){var u=l[h];delete d[u.start],delete u.start,delete u.end,u.forEach(function(f){t[f<0?~f:f]=1}),r.push(u)}}return c(s,n),c(n,s),e.forEach(function(l){t[l<0?~l:l]||r.push([l])}),r}function Fl(i){return Ic(i,l_.apply(this,arguments))}function l_(i,e,t){var n,s,r;if(arguments.length>1)n=c_(i,e,t);else for(s=0,n=new Array(r=i.arcs.length);s<r;++s)n[s]=s;return{type:"MultiLineString",arcs:o_(i,n)}}function c_(i,e,t){var n=[],s=[],r;function a(h){var u=h<0?~h:h;(s[u]||(s[u]=[])).push({i:h,g:r})}function o(h){h.forEach(a)}function c(h){h.forEach(o)}function l(h){h.forEach(c)}function d(h){switch(r=h,h.type){case"GeometryCollection":h.geometries.forEach(d);break;case"LineString":o(h.arcs);break;case"MultiLineString":case"Polygon":c(h.arcs);break;case"MultiPolygon":l(h.arcs);break}}return d(e),s.forEach(t==null?function(h){n.push(h[0].i)}:function(h){t(h[0].g,h[h.length-1].g)&&n.push(h[0].i)}),n}const u_=40,h_=70,as=1,gt=new WeakMap;let Zs=null;function Js(i,e,t=1.03){const n=(90-i)*(Math.PI/180),s=(e+180)*(Math.PI/180);return new U(-t*Math.sin(n)*Math.cos(s),t*Math.cos(n),t*Math.sin(n)*Math.sin(s))}function Ln(){const i=getComputedStyle(document.documentElement);return{neonCyan:i.getPropertyValue("--neon-cyan").trim(),neonGreen:i.getPropertyValue("--neon-green").trim(),neonAmber:i.getPropertyValue("--neon-amber").trim(),neonMagenta:i.getPropertyValue("--neon-magenta").trim(),panelBorder:i.getPropertyValue("--panel-border").trim()}}function ai(i,e){return i<=u_?e.neonGreen:i<=h_?e.neonAmber:e.neonMagenta}const d_={uniforms:{tDiffuse:{value:null},shiftAmt:{value:0}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}",fragmentShader:`
    uniform sampler2D tDiffuse;
  ...
  `};function Nc(i,{autoRotate:e=!0,bloomStrength:t=.4}={}){const n=new AbortController,{signal:s}=n,r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=Ln(),o=new Ug({antialias:!0,alpha:!0});o.setPixelRatio(window.devicePixelRatio),o.setSize(i.clientWidth||800,i.clientHeight||600),o.domElement.classList.add("s9-threatmap__canvas"),i.appendChild(o.domElement);const c=new lh,l=new $t(45,(i.clientWidth||800)/(i.clientHeight||600),.1,100);l.position.set(0,0,3);const d=new qn(as,48,48),h=new qn(as*.999,48,48),u=new Wn({color:new Ne(a.neonCyan||"rgba(0, 192, 156, 225)"),wireframe:!0,transparent:!0,opacity:.0015,depthTest:!1,depthWrite:!1,side:It}),f=new wt(d,u);f.renderOrder=0,c.add(f);const g=new Wn({colorWrite:!1,depthWrite:!0,depthTest:!0,depthFunc:tr,side:It}),M=new wt(h,g);M.renderOrder=1,c.add(M);const m=new Wn({color:new Ne(a.neonCyan||"#00d4b0"),wireframe:!0,transparent:!0,opacity:.017,depthTest:!0,depthWrite:!1,side:pn}),p=new wt(d,m);p.renderOrder=2,c.add(p);const S=new Og(l,o.domElement);S.enableDamping=!0,S.dampingFactor=.05,S.autoRotate=e&&!r,S.autoRotateSpeed=.4,S.enablePan=!1,S.minDistance=1.5,S.maxDistance=5;const T=new e_(o),y=new t_(c,l);T.addPass(y);const R=new zi(new Ae(i.clientWidth||800,i.clientHeight||600),t,.55,.75);T.addPass(R);const A=new Dc(d_);A.enabled=!1,T.addPass(A);const P=document.createElement("div");P.className="s9-threatmap__overlay",P.innerHTML=`
  ...
  `,i.appendChild(P);let v=null;function b(){v=requestAnimationFrame(b),S.update(),T.render()}b();let q=null;S.addEventListener("start",()=>{S.autoRotate=!1,q!==null&&(clearTimeout(q),q=null);const D=gt.get(i);D&&(D.cameraLerpTarget=null,D.lastOrbitInteraction=Date.now())}),S.addEventListener("end",()=>{!r&&e&&(q=setTimeout(()=>{S.autoRotate=!0,q=null},6e3))});const C=new ResizeObserver(()=>{const D=i.clientWidth,O=i.clientHeight;!D||!O||(l.aspect=D/O,l.updateProjectionMatrix(),o.setSize(D,O),T.setSize(D,O),R.resolution.set(D,O))});C.observe(i);const H=new zh;o.domElement.addEventListener("click",D=>{const O=gt.get(i);if(!O)return;const N=o.domElement.getBoundingClientRect(),Z=N.width,j=N.height,oe=(D.clientX-N.left)/Z*2-1,de=-((D.clientY-N.top)/j)*2+1;H.setFromCamera(new Ae(oe,de),l);const ue=Array.from(O.nodeMap.values()).map(Je=>Je.mesh),Ie=H.intersectObjects(ue,!1);if(Ie.length>0){const Je=Ie[0].object;gn(i,Je.userData.nodeId)}else O.activeNodeId!==null&&gn(i,null)},{signal:s}),gt.set(i,{animFrameId:v,renderer:o,composer:T,bloomPass:R,controls:S,scene:c,camera:l,resizeObserver:C,nodeMap:new Map,edgeMap:new Map,abortController:n,resumeTimer:null,reducedMotion:r,activeNodeId:null,colors:a,globeGeo:d,occluderGeo:h,globeBack:f,occluder:M,globeFront:p,geoGroup:null,cameraLerpTarget:null,lastOrbitInteraction:0,arcs:[],satelliteMode:!1,sunAngle:Math.random()*Math.PI*2,satelliteGroup:null,glitchPass:A,glitchActive:null,glitchNext:performance.now()+8e3+Math.random()*12e3});const G=gt.get(i);G.animFrameId=v,cancelAnimationFrame(v);function W(){const D=gt.get(i);if(D){D.animFrameId=requestAnimationFrame(W),D.cameraLerpTarget&&Date.now()-D.lastOrbitInteraction>=3e3&&(D.camera.position.lerp(D.cameraLerpTarget,.06),D.camera.position.distanceTo(D.cameraLerpTarget)<.04&&(D.camera.position.copy(D.cameraLerpTarget),D.cameraLerpTarget=null)),D.controls.update();for(let O=D.arcs.length-1;O>=0;O--){const N=D.arcs[O],Z=Math.min(1,(Date.now()-N.t0)/N.dur);if(N.particle.position.copy(N.curve.getPoint(Z)),Z>.75){const j=1-(Z-.75)/.25;N.ptMat.opacity=.9*j,N.lineMat.opacity=.1*j}Z>=1&&(D.scene.remove(N.line),D.scene.remove(N.particle),N.lineGeo.dispose(),N.lineMat.dispose(),N.ptGeo.dispose(),N.ptMat.dispose(),D.arcs.splice(O,1))}if(D.satelliteMode&&D.satMat&&(D.sunAngle+=15e-5,D.satMat.uniforms.sunDir.value.set(Math.cos(D.sunAngle),.22,Math.sin(D.sunAngle)).normalize()),m_(D),D.activeNodeId!==null){const O=D.nodeMap.get(D.activeNodeId),N=i.querySelector(".s9-threatmap__crosshair");if(O&&N){const Z=i.clientWidth,j=i.clientHeight,oe=O.mesh.position.clone().project(D.camera),de=(oe.x*.5+.5)*Z,ue=(-oe.y*.5+.5)*j;N.style.left=`${de}px`,N.style.top=`${ue}px`}}D.composer.render()}}G.animFrameId=requestAnimationFrame(W),p_(i)}function to(i,{id:e,lat:t,lng:n,label:s,level:r}){const a=gt.get(i);if(!a)return;if(a.nodeMap.has(e)){console.warn(`[s9-threatmap] addNode: node "${e}" already exists.`);return}const o=Ln(),c=ai(r,o),l=new qn(.032,8,8),d=new Wn({color:new Ne(c)}),h=new wt(l,d),u=Js(t,n);h.position.copy(u),h.userData.nodeId=e,h.userData.label=s,h.userData.lat=t,h.userData.lng=n,h.userData.level=r,a.scene.add(h),a.nodeMap.set(e,{mesh:h,lat:t,lng:n,label:s,level:r}),Fc(i)}function Uc(i,e){const t=gt.get(i);if(!t)return;const n=t.nodeMap.get(e);if(!n){console.warn(`[s9-threatmap] removeNode: node "${e}" not found.`);return}t.activeNodeId===e&&gn(i,null);for(const[s,r]of t.edgeMap)(r.from===e||r.to===e)&&f_(i,s);n.mesh.geometry.dispose(),n.mesh.material.dispose(),t.scene.remove(n.mesh),t.nodeMap.delete(e),Fc(i)}function f_(i,e){const t=gt.get(i);if(!t)return;const n=t.edgeMap.get(e);n&&(n.line.geometry.dispose(),n.line.material.dispose(),t.scene.remove(n.line),t.edgeMap.delete(e))}function gn(i,e){const t=gt.get(i);if(!t)return;if(t.activeNodeId!==null){const c=t.nodeMap.get(t.activeNodeId);if(c){const u=Ln();c.mesh.material.color.set(ai(c.level,u))}const l=i.querySelector(".s9-threatmap__crosshair");if(l){l.classList.remove("s9-threatmap__crosshair--visible");const u=l.querySelector(".s9-threatmap__crosshair-label");u&&(u.textContent="")}i.removeAttribute("data-active-node");const d=i.querySelector(".s9-threatmap__coords-lat"),h=i.querySelector(".s9-threatmap__coords-lng");d&&(d.textContent="LAT: --.-°"),h&&(h.textContent="LNG: --.-°"),i.dispatchEvent(new CustomEvent("s9:threatmap-node-deselect",{bubbles:!0,detail:{nodeId:t.activeNodeId}})),t.activeNodeId=null}if(e===null)return;const n=t.nodeMap.get(e);if(!n)return;const s=Ln();n.mesh.material.color.set(ai(n.level,s));const r=i.querySelector(".s9-threatmap__crosshair");if(r){r.classList.add("s9-threatmap__crosshair--visible");const c=r.querySelector(".s9-threatmap__crosshair-label");c&&(c.textContent=n.label)}i.setAttribute("data-active-node",e);const a=i.querySelector(".s9-threatmap__coords-lat"),o=i.querySelector(".s9-threatmap__coords-lng");a&&(a.textContent=`LAT: ${n.lat.toFixed(2)}°`),o&&(o.textContent=`LNG: ${n.lng.toFixed(2)}°`),t.activeNodeId=e,i.dispatchEvent(new CustomEvent("s9:threatmap-node-select",{bubbles:!0,detail:{nodeId:e,label:n.label,lat:n.lat,lng:n.lng,level:n.level}}))}function An(i,e){if(!gt.get(i))return;const n=Math.max(0,Math.min(100,e));i.setAttribute("data-threat-level",n)}function lr(i,e,t){const n=gt.get(i);if(!n)return;const s=n.nodeMap.get(e);if(!s)return;const r=s.level;if(s.level=t,s.mesh.userData.level=t,n.activeNodeId!==e){const a=Ln();s.mesh.material.color.set(ai(t,a))}return r}function oi(i,e){const t=gt.get(i);if(!t)return;const n=t.nodeMap.get(e);if(!n||Date.now()-t.lastOrbitInteraction<3e3)return;const s=t.camera.position.length();t.cameraLerpTarget=n.mesh.position.clone().normalize().multiplyScalar(s),t.controls.autoRotate=!1,t.resumeTimer!==null&&(clearTimeout(t.resumeTimer),t.resumeTimer=null)}async function p_(i){let e;try{const d=await fetch("/data/countries-110m.json");if(!d.ok)throw new Error(`HTTP ${d.status}`);e=await d.json(),Zs=e}catch(d){console.warn("[s9-threatmap] geo lines: failed to load /data/countries-110m.json",d);return}const t=gt.get(i);if(!t)return;const n=Ln(),s=new Ri,r=Fl(e,e.objects.land),a=new Ii({color:new Ne(n.neonCyan||"#00d4b0"),transparent:!0,opacity:.75,depthWrite:!1}),o=new Ii({color:new Ne(n.neonCyan||"#00d4b0"),transparent:!0,opacity:.22,depthWrite:!1});for(const d of r.coordinates){const h=d.map(([p,S])=>Js(S,p,1.002)),u=d.map(([p,S])=>Js(S,p,1.006)),f=new Ct().setFromPoints(h),g=new Ct().setFromPoints(u),M=new Ji(g,o);M.userData.geoType="coast";const m=new Ji(f,a);m.userData.geoType="coast",s.add(M),s.add(m)}const c=Fl(e,e.objects.countries,(d,h)=>d!==h),l=new Ii({color:new Ne(n.neonCyan||"#00d4b0"),transparent:!0,opacity:.32,depthWrite:!1});for(const d of c.coordinates){const h=d.map(([g,M])=>Js(M,g,1.002)),u=new Ct().setFromPoints(h),f=new Ji(u,l);f.userData.geoType="border",s.add(f)}t.scene.add(s),t.satelliteMode&&(s.visible=!1),t.geoGroup=s}function Fc(i){const e=gt.get(i);if(!e)return;const t=i.querySelector(".s9-threatmap__node-count");t&&(t.textContent=`NODES: ${e.nodeMap.size}`)}function m_(i){const e=i.glitchPass;if(!e)return;const t=performance.now()*.001;e.uniforms.shiftAmt.value=.4+Math.sin(t*.6)*.2}function Ol(i,e){const t=gt.get(i);if(!t||t.reducedMotion)return;const n=t.nodeMap.get(e);if(!n)return;const s=Ln(),r=ai(n.level,s),a=20,o=.035,c=[];for(let M=0;M<=a;M++){const m=M/a*Math.PI*2;c.push(new U(Math.cos(m)*o,Math.sin(m)*o,0))}const l=new Ct().setFromPoints(c),d=new Ii({color:new Ne(r),transparent:!0,opacity:.9,depthWrite:!1}),h=new vh(l,d);h.position.copy(n.mesh.position);const u=n.mesh.position.clone().normalize();h.quaternion.setFromUnitVectors(new U(0,0,1),u),t.scene.add(h);const f=Date.now(),g=700;(function M(){if(!gt.get(i)){t.scene.remove(h),l.dispose(),d.dispose();return}const m=Math.min(1,(Date.now()-f)/g);h.scale.setScalar(1+m*6),d.opacity=.85*(1-m),m<1?requestAnimationFrame(M):(t.scene.remove(h),l.dispose(),d.dispose())})()}function Bl(i){const e=gt.get(i);if(!e)return;const t=Ln();e.colors=t;const n=t.neonCyan||"#00d4b0";e.globeBack&&e.globeBack.material.color.set(n),e.globeFront&&e.globeFront.material.color.set(n),e.geoGroup&&e.geoGroup.traverse(s=>{if(s.isLine){const r=s.userData.geoType==="coast"?t.neonCyan:t.panelBorder;s.material.color.set(r||"#ffffff")}});for(const s of e.nodeMap.values()){const r=ai(s.level,t);s.mesh.material.color.set(r),s.mesh.material.emissive.set(r)}}function Oc(i,e,t){const n=gt.get(i);if(!n||n.reducedMotion)return;const s=n.nodeMap.get(e),r=n.nodeMap.get(t);if(!s||!r)return;const a=Ln(),o=ai(r.level,a),c=s.mesh.position.clone(),l=r.mesh.position.clone(),d=c.clone().add(l).multiplyScalar(.5),h=.2+d.length()*.25,u=d.clone().normalize().multiplyScalar(as+h),f=new yh(c,u,l),g=new Ct().setFromPoints(f.getPoints(48)),M=new Ii({color:new Ne(o),transparent:!0,opacity:.1,depthWrite:!1}),m=new Ji(g,M);m.renderOrder=2;const p=new qn(.009,4,4),S=new Wn({color:new Ne(o),transparent:!0,opacity:.9}),T=new wt(p,S);T.renderOrder=3,T.position.copy(c),n.scene.add(m),n.scene.add(T),n.arcs.push({curve:f,line:m,lineGeo:g,lineMat:M,particle:T,ptGeo:p,ptMat:S,t0:Date.now(),dur:1e3+Math.random()*700})}function Qi(i,e,t,n){return[(e+180)/360*t,(90-i)/180*n]}function g_(i=null){const n=document.createElement("canvas");n.width=2048,n.height=1024;const s=n.getContext("2d"),r=s.createLinearGradient(0,0,0,1024);if(r.addColorStop(0,"#071a2e"),r.addColorStop(.15,"#082035"),r.addColorStop(.5,"#0a2a46"),r.addColorStop(.85,"#082035"),r.addColorStop(1,"#071a2e"),s.fillStyle=r,s.fillRect(0,0,2048,1024),i){const a=a_(i,i.objects.land),c=(a.type==="FeatureCollection"?a.features:[a]).flatMap(h=>{const u=h.geometry;return u?u.type==="Polygon"?[u.coordinates]:u.coordinates:[]}),l=s.createLinearGradient(0,0,0,1024);l.addColorStop(0,"#dce8dc"),l.addColorStop(.06,"#8a9c7a"),l.addColorStop(.16,"#527848"),l.addColorStop(.28,"#4e7040"),l.addColorStop(.4,"#4a6c34"),l.addColorStop(.5,"#3a5c24"),l.addColorStop(.6,"#4a6c34"),l.addColorStop(.72,"#4e7040"),l.addColorStop(.84,"#7a8c6a"),l.addColorStop(.92,"#ccd8c4"),l.addColorStop(1,"#eaf0ea");for(const h of c)for(let u=0;u<h.length;u++){const f=h[u];s.beginPath();for(let g=0;g<f.length;g++){const[M,m]=f[g],p=(M+180)/360*2048,S=(90-m)/180*1024;g===0?s.moveTo(p,S):s.lineTo(p,S)}s.closePath(),s.fillStyle=u===0?l:"#0a2a46",s.fill()}const d=[[22,15,16,28,"rgba(172,142, 88,0.72)"],[23,44,8,12,"rgba(178,148, 96,0.68)"],[27,70,5,9,"rgba(182,158,112,0.52)"],[42,100,6,16,"rgba(152,128, 86,0.58)"],[-25,132,10,17,"rgba(168,134, 82,0.58)"],[-22,-68,4,6,"rgba(142,118, 76,0.48)"],[35,-114,5,8,"rgba(158,128, 82,0.42)"],[40,58,5,8,"rgba(158,134, 88,0.45)"]];for(const[h,u,f,g,M]of d){const[m,p]=Qi(h,u,2048,1024),S=g/360*2048,T=f/180*1024,y=s.createRadialGradient(m,p,0,m,p,Math.max(S,T)),R=M.replace(/[\d.]+\)$/,"0)");y.addColorStop(0,M),y.addColorStop(.55,M),y.addColorStop(.88,M.replace(/[\d.]+\)$/,"0.08)")),y.addColorStop(1,R),s.fillStyle=y,s.beginPath(),s.ellipse(m,p,S,T,0,0,Math.PI*2),s.fill()}s.strokeStyle="rgba(120,175,210,0.22)",s.lineWidth=.8;for(const h of c){const u=h[0];s.beginPath();for(let f=0;f<u.length;f++){const[g,M]=u[f],m=(g+180)/360*2048,p=(90-M)/180*1024;f===0?s.moveTo(m,p):s.lineTo(m,p)}s.closePath(),s.stroke()}}s.strokeStyle="rgba(100,150,200,0.04)",s.lineWidth=.5;for(let a=-80;a<=80;a+=30){const o=Qi(a,0,2048,1024)[1];s.beginPath(),s.moveTo(0,o),s.lineTo(2048,o),s.stroke()}for(let a=-180;a<=180;a+=30){const o=Qi(0,a,2048,1024)[0];s.beginPath(),s.moveTo(o,0),s.lineTo(o,1024),s.stroke()}return n}function __(){const t=document.createElement("canvas");t.width=1024,t.height=512;const n=t.getContext("2d");n.fillStyle="#000810",n.fillRect(0,0,1024,512);const s=[[40.7,-74,4],[34,-118.2,3.5],[41.9,-87.6,3],[29.8,-95.4,2.5],[19.4,-99.1,3],[43.7,-79.4,3],[45.5,-73.6,2.5],[49.3,-123.1,2],[38.9,-77,2.5],[42.4,-71.1,2.5],[32.8,-96.8,2.5],[33.7,-84.4,2],[37.8,-122.4,2.5],[47.6,-122.3,2],[39.7,-105,2],[33.4,-112.1,2],[36.2,-115.1,2],[29.4,-98.5,2],[32.7,-97.1,2],[30.3,-81.7,1.5],[51,-114.1,2],[53.5,-113.5,2],[49.9,-97.1,2],[14.1,-87.2,1.5],[13.7,-89.2,1.5],[-23.5,-46.6,4],[-22.9,-43.2,3.5],[-34.6,-58.4,3.5],[-12,-77,2],[4.7,-74.1,2],[10.5,-66.9,2],[-33.5,-70.7,2.5],[-3.7,-38.5,2],[-8.1,-34.9,2],[-19.9,-43.9,2.5],[-30,-51.2,2],[-15.8,-47.9,2],[51.5,-.1,4],[48.9,2.3,4],[52.5,13.4,3.5],[55.8,37.6,4],[41,28.9,3.5],[59.9,10.8,2],[59.3,18.1,2],[60.2,25,2],[52.2,21,2.5],[50.1,14.4,2.5],[47.5,19,2.5],[48.2,16.4,2.5],[47.4,8.5,2.5],[48.1,11.6,3],[52.4,4.9,3],[40.4,-3.7,3],[41.4,2.2,3],[45.5,9.2,3],[41.9,12.5,3],[37.9,23.7,2.5],[50,8.7,2.5],[51,13.7,2],[51.2,6.8,2.5],[50.9,4.3,2.5],[53.5,-2.2,2],[55.7,12.6,2],[50.5,30.5,2.5],[59.5,30.3,2.5],[48,37.8,2],[46.5,30.7,2],[49.8,24,2],[50.4,30.5,2],[45.4,28,2],[44.4,26.1,2],[42.7,23.3,2],[37.1,-8.6,2],[30.1,31.3,3.5],[25.2,55.3,2.5],[33.3,44.4,2.5],[35.7,51.4,3],[24.7,46.7,2.5],[31.8,35.2,2],[33.9,35.5,2],[36.8,10.2,2],[32.9,13.2,2],[30.7,29.7,2],[6.5,3.4,2.5],[-26.2,28,3],[-33.9,18.4,2],[-1.3,36.8,2],[5.3,-4,2],[14.7,17.4,1.5],[9.1,7.4,2],[4.4,18.6,1.5],[-4.3,15.3,1.5],[-11.7,43.3,1.5],[-18.9,47.5,1.5],[28.6,77.2,4],[19.1,72.9,3.5],[12.9,77.6,3],[23.7,90.4,3],[24.9,67,2.5],[31.6,74.3,2.5],[33.7,73.1,2],[17.4,78.5,2.5],[22.6,88.4,2.5],[13.1,80.3,2.5],[23,72.6,2],[22.3,70.8,2],[26.9,75.8,2],[21.2,81.4,2],[27.7,85.3,2],[41.3,69.2,2],[43.3,76.9,2],[51.2,71.5,1.5],[53.9,27.6,2],[54.7,55.9,2],[56.8,60.6,2],[55,73.4,2],[56,92.9,2],[52.3,104.3,2],[53.7,87.1,2],[62,129.7,1.5],[43.1,131.9,2],[61.8,34.4,2],[35.7,139.7,5],[37.5,127,4],[39.9,116.4,4.5],[31.2,121.5,4.5],[23.1,113.3,4],[22.3,114.2,3.5],[30.6,104.1,3.5],[32.1,118.8,3.5],[30.3,120.2,3],[36.7,117,2.5],[34.3,108.9,2.5],[26,119.3,2.5],[41.8,123.4,2.5],[45.8,126.5,2.5],[34.6,135.5,3.5],[33.6,130.4,3],[1.3,103.8,3.5],[13.7,100.5,2.5],[10.8,106.7,2.5],[14.6,121,2.5],[3.1,101.7,2.5],[6.2,106.8,3],[21,105.8,2],[-6.2,106.8,2.5],[-33.9,151.2,2.5],[-37.8,144.9,2],[-27.5,153,2],[-31.9,115.9,2],[-43.5,172.6,1.5]];for(const[r,a,o]of s){const[c,l]=Qi(r,a,1024,512),d=o*2.2,h=n.createRadialGradient(c,l,0,c,l,d);h.addColorStop(0,"rgba(255,210,120,0.22)"),h.addColorStop(.5,"rgba(255,170,60,0.08)"),h.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=h,n.beginPath(),n.arc(c,l,d,0,Math.PI*2),n.fill()}n.globalCompositeOperation="lighter";for(const[r,a,o]of s){const[c,l]=Qi(r,a,1024,512),d=Math.max(1,o*.9),h=n.createRadialGradient(c,l,0,c,l,d);h.addColorStop(0,`rgba(255,245,200,${Math.min(.9,.5+o*.1)})`),h.addColorStop(.6,"rgba(255,200,100,0.15)"),h.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=h,n.beginPath(),n.arc(c,l,d,0,Math.PI*2),n.fill()}return n.globalCompositeOperation="source-over",t}function zl(i){return new Promise((e,t)=>{new Nh().load(i,e,void 0,t)})}async function v_(i){const e=gt.get(i);if(!e||e.satelliteGroup)return;let t,n,s=1;try{[t,n]=await Promise.all([zl("/textures/earth_day.jpg"),zl("/textures/earth_night.jpg")]),t.colorSpace=zt,n.colorSpace=zt}catch(u){if(console.warn("[s9-threatmap] satellite textures not found, using procedural fallback",u),!Zs)try{const f=await fetch("/data/countries-110m.json");f.ok&&(Zs=await f.json())}catch{}t=new tl(g_(Zs)),n=new tl(__()),s=0}const r=new bt({uniforms:{dayMap:{value:t},nightMap:{value:n},sunDir:{value:new U(Math.cos(e.sunAngle),.22,Math.sin(e.sunAngle)).normalize()},realTex:{value:s}},vertexShader:`
    ...
    `}),a=new qn(as,64,32),o=new wt(a,r);o.renderOrder=0;const c=new qn(as*1.055,32,16),l=new bt({uniforms:{glowCol:{value:new Ne(51455)}},vertexShader:`
      varying vec3 vNormal;
    ...
    `,side:pn,blending:er,transparent:!0,depthWrite:!1}),d=new wt(c,l);d.renderOrder=1;const h=new Ri;h.add(o),h.add(d),h.visible=!1,e.scene.add(h),Object.assign(e,{satelliteGroup:h,satGeo:a,satMat:r,atmGeo:c,atmMat:l,dayTex:t,nightTex:n})}async function x_(i,e){const t=gt.get(i);t&&(e?(t.globeBack&&(t.globeBack.visible=!1),t.occluder&&(t.occluder.visible=!1),t.globeFront&&(t.globeFront.visible=!1),t.geoGroup&&(t.geoGroup.visible=!1),t.bloomPass&&(t._bloomPrev={strength:t.bloomPass.strength,threshold:t.bloomPass.threshold,radius:t.bloomPass.radius},t.bloomPass.strength=.32,t.bloomPass.threshold=.85,t.bloomPass.radius=.35),t.satelliteMode=!0,await v_(i),t.satelliteGroup&&(t.satelliteGroup.visible=!0)):(t.satelliteGroup&&(t.satelliteGroup.visible=!1),t.globeBack&&(t.globeBack.visible=!0),t.occluder&&(t.occluder.visible=!0),t.globeFront&&(t.globeFront.visible=!0),t.geoGroup&&(t.geoGroup.visible=!0),t.bloomPass&&t._bloomPrev&&(t.bloomPass.strength=t._bloomPrev.strength,t.bloomPass.threshold=t._bloomPrev.threshold,t.bloomPass.radius=t._bloomPrev.radius),t.satelliteMode=!1))}const M_=new WeakMap;function S_(i){const e=new AbortController;M_.set(i,e),i.classList.add("s9-panel--booting"),i.addEventListener("animationend",t=>{t.animationName==="crt-flicker"&&(i.classList.remove("s9-panel--booting"),i.dispatchEvent(new CustomEvent("s9:panel-mount",{bubbles:!0,detail:{id:i.dataset.s9Id??null}})))},{signal:e.signal,once:!0})}const na=["complete","active","failed","pending"];function E_(i,e){if(!na.includes(e)){console.warn(`[s9-sequence] Unknown state: "${e}". Expected one of: ${na.join(", ")}.`);return}na.forEach(t=>i.classList.remove(`s9-sequence__entry--${t}`)),e==="failed"?(i.classList.add("s9-sequence__entry--fail-flash"),i.addEventListener("animationend",()=>{i.classList.remove("s9-sequence__entry--fail-flash"),i.classList.add("s9-sequence__entry--failed"),Hl(i,e)},{once:!0})):(i.classList.add(`s9-sequence__entry--${e}`),Hl(i,e))}function Hl(i,e){i.dispatchEvent(new CustomEvent("s9:sequence-step-change",{bubbles:!0,detail:{state:e}}))}const Qs={"":"MATRIX GREEN",gits:"GHOST IN THE SHELL",amber:"AMBER",phosphor:"PHOSPHOR",blood:"BLOOD"};function no(i){const e=document.documentElement;i===""||i==="matrixgreen"?delete e.dataset.theme:e.dataset.theme=i,document.querySelectorAll(".topbar__theme-btn").forEach(t=>{t.classList.toggle("topbar__theme-btn--active",(t.dataset.themeSet??"")===(i==="matrixgreen"?"":i))}),Bl(Ye),io&&Bl(document.getElementById("threatmap-tactical"))}function Bc(){const i=new Date;document.getElementById("topbar-clock").textContent=`UTC ${i.toUTCString().split(" ")[4]}`}Bc();setInterval(Bc,1e3);document.querySelectorAll(".s9-panel").forEach(S_);document.querySelectorAll(".topbar__theme-btn").forEach(i=>{i.addEventListener("click",()=>{const e=i.dataset.themeSet??"";no(e),Ce(Te,`THEME: ${Qs[e]??e.toUpperCase()}`,"sys")})});const zc=document.querySelectorAll(".topbar__tab[data-tab]"),b_=document.querySelectorAll(".center__view[data-view]");let Gl=!1,io=!1;function Vl(i){zc.forEach(e=>{const t=e.dataset.tab===i;e.classList.toggle("topbar__tab--active",t),e.setAttribute("aria-selected",t)}),b_.forEach(e=>{e.classList.toggle("center__view--active",e.dataset.view===i)}),i==="network"&&!Gl&&(Gl=!0,K_()),i==="tactical"&&!io&&(io=!0,$_()),Ce(Te,`VIEW: ${i.toUpperCase()} ACTIVATED`,"sys")}zc.forEach(i=>{i.addEventListener("click",()=>Vl(i.dataset.tab)),i.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),Vl(i.dataset.tab))})});const Te=document.querySelector(".s9-terminal");Jc(Te,{onSubmit(i){var s;const e=i.trim().split(/\s+/),t=e[0].toLowerCase(),n=e.slice(1);switch(t){case"help":Ce(Te,"SECTION 9 COMMAND INTERFACE — AVAILABLE COMMANDS:","sys"),Ce(Te,"  status              — system status report","info"),Ce(Te,"  ghost               — ghost coefficient analysis","info"),Ce(Te,"  nodes               — list active threat nodes","info"),Ce(Te,"  threat <lvl>        — set global threat level 0-100","info"),Ce(Te,"  threat <id> <lvl>   — set node threat level","info"),Ce(Te,"  focus <id>          — focus camera on node","info"),Ce(Te,"  theme <name>        — switch theme","info"),Ce(Te,"  themes              — list available themes","info"),Ce(Te,"  clear               — clear terminal","info");break;case"status":{const r=lt.size,a=[...lt.values()].filter(c=>c>=70).length,o=r>0?Math.max(...lt.values()):0;Ce(Te,"── SYSTEM STATUS ──────────────────────────","sys"),Ce(Te,`  CPU: ${Bt.cpu}%   MEM: ${Bt.mem}%   NET I/O: ${Bt.net}%`,"info"),Ce(Te,`  GHOST LAYER: ${Bt.ghost}%   ENCRYPTION: ${Bt.enc}%`,"info"),Ce(Te,`  NODES ON GRID: ${r}   CRITICAL: ${a}`,a>0?"err":"info"),Ce(Te,`  PEAK THREAT: ${o}   GLOBAL LEVEL: ${o}`,o>=70?"err":"sys"),Ce(Te,"  SECURE CHANNEL: ACTIVE   ENCRYPTION: AES-256","info");break}case"ghost":{const r=Ci.toFixed(1);Ce(Te,"── GHOST COEFFICIENT ANALYSIS ─────────────","sys"),Ce(Te,`  COEFFICIENT: ${r}%   BARRIER: NOMINAL`,"info"),Ce(Te,"  CYBER BRAIN: SECTION 9 CLEARANCE ALPHA-7","info"),Ce(Te,"  DIVE DEPTH: STABLE 3.2m   TACHIKOMA LINK: ACTIVE","info"),Ce(Te,"  IDENTITY: CONFIRMED — KUSANAGI.M",r>=95?"sys":"err");break}case"nodes":{if(lt.size===0){Ce(Te,"NO NODES ON GRID","info");break}Ce(Te,`ACTIVE NODES (${lt.size}):`,"sys");for(const[r,a]of lt){const o=un.find(d=>d.id===r),c=(o==null?void 0:o.label)??r,l=a>=70?"err":a>=40?"sys":"info";Ce(Te,`  ${r.padEnd(14)} ${c.padEnd(12)} LVL=${a}`,l)}break}case"threat":{if(n.length===0){Ce(Te,`GLOBAL THREAT: ${Math.max(0,...lt.values())}`,"sys");break}if(n.length>=2&&isNaN(parseInt(n[0]))){const r=n[0],a=parseInt(n[1]);if(!lt.has(r)){Ce(Te,`ERR: node '${r}' not found — use NODES to list`,"err");break}if(isNaN(a)||a<0||a>100){Ce(Te,"ERR: level must be 0-100","err");break}const o=lr(Ye,r,a);lt.set(r,a),An(Ye,Math.max(0,...lt.values())),Ce(Te,`NODE ${r}: ${o} → ${a}`,a>=70?"err":"sys"),a>=70&&o<70&&(gn(Ye,r),oi(Ye,r))}else{const r=parseInt(n[0]);if(isNaN(r)||r<0||r>100){Ce(Te,"ERR: level must be 0-100","err");break}An(Ye,r),Ce(Te,`GLOBAL THREAT LEVEL SET: ${r}`,"sys")}break}case"focus":{const r=n[0];if(!r){Ce(Te,"ERR: focus requires a node id — use NODES to list","err");break}if(!lt.has(r)){Ce(Te,`ERR: node '${r}' not found`,"err");break}gn(Ye,r),oi(Ye,r);const a=un.find(o=>o.id===r);Ce(Te,`CAMERA FOCUSED: ${(a==null?void 0:a.label)??r}`,"sys");break}case"theme":{const r=((s=n[0])==null?void 0:s.toLowerCase())??"";if(r===""||r==="matrixgreen"){no(""),Ce(Te,"THEME: MATRIX GREEN","sys");break}if(!Object.keys(Qs).includes(r)){Ce(Te,`ERR: unknown theme '${r}' — use THEMES to list`,"err");break}no(r),Ce(Te,`THEME: ${Qs[r]}`,"sys");break}case"themes":Ce(Te,"AVAILABLE THEMES:","sys");for(const[r,a]of Object.entries(Qs))Ce(Te,`  ${(r||"matrixgreen").padEnd(14)} ${a}`,"info");break;case"clear":Qc(Te),Ce(Te,"TERMINAL CLEARED","sys");break;default:t&&Ce(Te,`ERR: unknown command '${i}' — type HELP`,"err")}},tabComplete(i){return["help","status","ghost","nodes","threat","focus","theme","themes","clear"].find(t=>t.startsWith(i.toLowerCase()))??null}});Ce(Te,"SECTION 9 OPERATIVE INTERFACE — TYPE HELP FOR COMMANDS","sys");Ce(Te,"GHOST BABEL OPERATION: ACTIVE","info");function ia(i,e,t){let n=0;function s(){if(n>=i.length)return;const{id:r,state:a}=i[n++],o=document.getElementById(r);o&&E_(o,a),setTimeout(s,n<i.length?e:e*2)}s()}const kl=[{cls:"sigint",headline:"SIGNAL INTERCEPT: FREQ 12.4GHz",detail:"Encrypted burst tx — POSEIDON signature"},{cls:"humint",headline:"ASSET CONFIRM: NIIHAMA-04",detail:"Target movement: port district, 0300 local"},{cls:"cyber",headline:"ZERO-DAY: CVE-2026-3917",detail:"Legacy auth stack — remote exec payload ready"},{cls:"ghost",headline:"DIVE ANOMALY: SECTOR ALPHA",detail:"Ghost-barrier interference at 4.1m depth"},{cls:"elint",headline:"DRONE SWEEP: SECTOR 12",detail:"Coverage 73% — ETA 4 minutes to full map"},{cls:"sigint",headline:"PACKET STORM: 192.168.7.0/24",detail:"18k pps sustained — possible DDoS staging"},{cls:"cyber",headline:"EXFIL CHANNEL COMPROMISED",detail:"Fallback route DELTA-9 now primary exfil"},{cls:"humint",headline:"CONTACT LOST: ROMEO-7",detail:"Last check-in 03:14:22 UTC — status unknown"},{cls:"ghost",headline:"TACHIKOMA: AUTONOMOUS SWEEP",detail:"Unit 9 executing sector 7 independently"},{cls:"elint",headline:"EM PULSE DETECTED: ZONE 3",detail:"Localized disruption — comm nodes offline"},{cls:"sigint",headline:"NODE COMMS SPIKE: BEIJING",detail:"340% increase in encrypted P2P — 0300-0500"},{cls:"cyber",headline:"FIREWALL PROBE: AS12345",detail:"Systematic port sweep — countermeasures deployed"},{cls:"humint",headline:"BROKER IDENTIFIED: LAUGHING MAN",detail:"Dark web auction — biotech data linked to incident"},{cls:"ghost",headline:"GHOST PROTOCOL: BETA-3",detail:"Shell confirmed on target system — extract ready"},{cls:"elint",headline:"SAT PASS: KH-17 WINDOW",detail:"6 min coverage — imaging tasked to sector 4"}];function y_(i){const e=document.createElement("div");return e.className=`sigint-item sigint-item--${i.cls}`,e.innerHTML=`
  ...
  `,e}(function(){const e=document.getElementById("intel-feed");if(!e)return;const t=5,n=[];function s(){const r=new Set(n.map(h=>{var u;return(u=h.querySelector(".intel-item__headline"))==null?void 0:u.textContent})),a=Wl.filter(h=>!r.has(h.headline)),o=a.length>0?a:Wl,c=o[Math.floor(Math.random()*o.length)],l=T_(c);e.insertBefore(l,e.firstChild),n.unshift(l),requestAnimationFrame(()=>l.classList.add("intel-item--visible"));const d=1e4+Math.random()*15e3;for(setTimeout(()=>{l.classList.add("intel-item--closing"),l.classList.remove("intel-item--visible"),setTimeout(()=>{l.remove();const h=n.indexOf(l);h>=0&&n.splice(h,1)},500)},d);n.length>t;){const h=n.pop();h.classList.add("intel-item--closing"),h.classList.remove("intel-item--visible"),setTimeout(()=>h.remove(),500)}setTimeout(s,4e3+Math.random()*8e3)}setTimeout(s,1200),setTimeout(s,3500),setTimeout(s,5800)})();setTimeout(()=>{ia([{id:"seq-breach",state:"complete"},{id:"seq-extract",state:"active"}],3e3),setTimeout(()=>{ia([{id:"seq-extract",state:"complete"},{id:"seq-cover",state:"active"}],3500),setTimeout(()=>{ia([{id:"seq-cover",state:"complete"},{id:"seq-exfil",state:"active"}],3e3)},9e3)},8e3)},5e3);const Hi=document.querySelector(".s9-stream");nu(Hi);const an=()=>`${ot(10,220)}.${ot(0,255)}.${ot(0,255)}.${ot(1,254)}`,sa=()=>[22,80,443,8443,4444,3389,21,1337,9999][Math.floor(Math.random()*9)],A_=()=>`${ot(64,65535)}B`,C_=()=>Array.from({length:4},()=>Math.floor(Math.random()*256).toString(16).padStart(2,"0")).join(" ");function w_(){const i=[()=>({source:"AUTH",message:`HANDSHAKE COMPLETE — ${an()}:${sa()}`,alert:!1}),()=>({source:"NET",message:`PKT ${A_()} ${an()} → ${an()}`,alert:!1}),()=>({source:"GHOST",message:`DIVE DEPTH: ${(2+Math.random()*3).toFixed(1)}m — STABLE`,alert:!1}),()=>({source:"CRYPT",message:"AES-256 SESSION KEY ESTABLISHED",alert:!1}),()=>({source:"SCAN",message:`PROBE: ${an()}:${sa()} — ${C_()}`,alert:!0}),()=>({source:"SYS",message:`MEM ${ot(60,92)}% CPU ${ot(20,80)}% THERMAL OK`,alert:!1}),()=>({source:"NET",message:`LATENCY ${ot(4,45)}ms — ${Math.random()<.8?"NOMINAL":"DEGRADED"}`,alert:Math.random()<.2}),()=>({source:"AUTH",message:`TOKEN REFRESH: UID-${ot(1e3,9999)}`,alert:!1}),()=>({source:"CRIT",message:`INTRUSION SIG: ${an()} PORT ${sa()}`,alert:!0}),()=>({source:"SYS",message:`COUNTERMEASURE DEPLOYED — BLOCK RULE ${ot(100,999)}`,alert:!1}),()=>({source:"NET",message:`ROUTE CHANGE: AS${ot(1e3,65e3)} VIA ${an()}`,alert:!1}),()=>({source:"CRYPT",message:`TLS 1.3 HANDSHAKE: ${an()} — ${ot(0,1)?"ECDH":"RSA"}-4096`,alert:!1}),()=>({source:"SCAN",message:`ANOMALY: BURST ${ot(800,9999)} PPS FROM ${an()}`,alert:!0}),()=>({source:"GHOST",message:`GHOST COEFFICIENT: ${(92+Math.random()*8).toFixed(1)}%`,alert:!1}),()=>({source:"AUTH",message:`CERT CHAIN VALID — SHA-${ot(0,1)?"256":"512"}`,alert:!1}),()=>({source:"NET",message:`DNS RESOLVE: ${["niihama.net","togusa.local","sec9.gov","puppet.io"][Math.floor(Math.random()*4)]}`,alert:!1}),()=>({source:"SYS",message:`FIREWALL RULE ${ot(1e3,9999)}: DROP ${an()}/${ot(24,32)}`,alert:!1}),()=>({source:"CRIT",message:`ZERO-DAY ATTEMPT: ${an()} — MITIGATED`,alert:!0})];function e(){const t=i[Math.floor(Math.random()*i.length)];ts(Hi,{timestamp:new Date().toISOString(),...t()})}for(let t=0;t<8;t++)e();setInterval(e,ot(1200,2800))}w_();const Bt={cpu:42,mem:61,net:12,ghost:77,enc:96},R_=document.getElementById("tele-cpu"),P_=document.getElementById("tele-mem"),L_=document.getElementById("tele-net"),D_=document.getElementById("tele-enc");setInterval(()=>{for(const i of Object.keys(Bt))Bt[i]=Math.max(5,Math.min(100,Bt[i]+(Math.random()-.5)*6)),Bt[i]=Math.round(Bt[i]);ms(R_,Bt.cpu),ms(P_,Bt.mem),ms(L_,Bt.net),ms(D_,Bt.enc)},2e3);const I_=document.getElementById("neural-01"),N_=document.getElementById("ghost-val"),U_=document.getElementById("cyber-index"),F_=document.getElementById("neural-sync"),Cn=document.getElementById("ekg-canvas"),O_=document.getElementById("ekg-bpm"),Gs=document.getElementById("ekg-heart");let Ci=98.4,cr=62,Gn=0,ra=0;const aa=.37;function Xl(){Gs&&(Gs.classList.remove("beat"),Gs.offsetWidth,Gs.classList.add("beat"))}function ql(i){return i>.08&&i<.18?Math.sin((i-.08)/.1*Math.PI)*.18:i>.28&&i<.32?-((i-.28)/.04)*.38:i>.32&&i<.37?-.38+(i-.32)/.05*1.38:i>.37&&i<.43?1-(i-.37)/.06*1.28:i>.43&&i<.49?-.28+(i-.43)/.06*.28:i>.52&&i<.68?Math.sin((i-.52)/.16*Math.PI)*.3:0}function B_(){if(!Cn)return;const i=Cn.getContext("2d"),e=Cn.width,t=Cn.height,n=t/2,s=t*.44,r=cr/60/80;i.clearRect(0,0,e,t);const a=getComputedStyle(document.documentElement).getPropertyValue("--neon-cyan").trim()||"#00d4b0";i.beginPath();for(let c=0;c<e;c++){const l=((Gn-(e-1-c)*r)%1+1)%1,d=n-ql(l)*s;c===0?i.moveTo(c,d):i.lineTo(c,d)}i.strokeStyle=a,i.lineWidth=1,i.shadowColor=a,i.shadowBlur=5,i.stroke();const o=n-ql(Gn)*s;i.beginPath(),i.arc(e-1,o,1.8,0,Math.PI*2),i.fillStyle=a,i.shadowBlur=10,i.fill()}function Hc(){if(!Cn)return;const i=Cn.clientWidth;i&&Cn.width!==i&&(Cn.width=i)}Hc();new ResizeObserver(Hc).observe(Cn);let oa=0;(function i(e){const t=oa?e-oa:16;oa=e,ra=Gn,Gn=(Gn+cr/60*(t/1e3))%1,(ra<aa&&Gn>=aa||ra>Gn&&Gn>=aa)&&Xl(),B_(),requestAnimationFrame(i)})(0);function Gc(){Ci=Math.max(85,Math.min(100,Ci+(Math.random()-.45)*1.2));const i=Ci.toFixed(1);cr=Math.round(58+(100-Ci)/15*12),O_.textContent=cr,iu(I_,()=>{N_.textContent=i,U_.textContent=`${i}%`,F_.textContent=`${Math.round(Ci)}%`})}for(let i=0;i<3;i++)Gc();setInterval(Gc,3e3);const Ye=document.querySelector(".s9-threatmap");Nc(Ye,{autoRotate:!0,bloomStrength:.4});document.getElementById("sat-toggle").addEventListener("change",i=>{x_(Ye,i.target.checked)});const un=[{id:"n-tokyo",lat:35.68,lng:139.69,label:"TOKYO"},{id:"n-moscow",lat:55.75,lng:37.62,label:"MOSCOW"},{id:"n-beijing",lat:39.91,lng:116.39,label:"BEIJING"},{id:"n-london",lat:51.51,lng:-.13,label:"LONDON"},{id:"n-nyc",lat:40.71,lng:-74,label:"NEW YORK"},{id:"n-sydney",lat:-33.87,lng:151.21,label:"SYDNEY"},{id:"n-dubai",lat:25.2,lng:55.27,label:"DUBAI"},{id:"n-saopaulo",lat:-23.55,lng:-46.63,label:"SÃO PAULO"},{id:"n-paris",lat:48.86,lng:2.35,label:"PARIS"},{id:"n-seoul",lat:37.57,lng:126.98,label:"SEOUL"},{id:"n-cairo",lat:30.05,lng:31.24,label:"CAIRO"},{id:"n-berlin",lat:52.52,lng:13.41,label:"BERLIN"},{id:"n-mumbai",lat:19.08,lng:72.88,label:"MUMBAI"},{id:"n-toronto",lat:43.65,lng:-79.38,label:"TORONTO"},{id:"n-singapore",lat:1.35,lng:103.82,label:"SINGAPORE"},{id:"n-nairobi",lat:-1.29,lng:36.82,label:"NAIROBI"},{id:"n-istanbul",lat:41.01,lng:28.97,label:"ISTANBUL"},{id:"n-lagos",lat:6.52,lng:3.38,label:"LAGOS"}],lt=new Map;function ot(i,e){return Math.floor(Math.random()*(e-i+1))+i}const z_={"n-tokyo":{country:"JAPAN",pop:"13.96M",status:"FINANCIAL HUB"},"n-moscow":{country:"RUSSIA",pop:"12.51M",status:"RESTRICTED"},"n-beijing":{country:"CHINA",pop:"21.54M",status:"RESTRICTED"},"n-london":{country:"UK",pop:"8.98M",status:"ALLIED NODE"},"n-nyc":{country:"USA",pop:"8.34M",status:"ALLIED NODE"},"n-sydney":{country:"AUSTRALIA",pop:"5.31M",status:"ALLIED NODE"},"n-dubai":{country:"UAE",pop:"3.33M",status:"NEUTRAL ZONE"},"n-saopaulo":{country:"BRAZIL",pop:"12.33M",status:"MONITORED"},"n-paris":{country:"FRANCE",pop:"2.15M",status:"ALLIED NODE"},"n-seoul":{country:"S.KOREA",pop:"9.78M",status:"ALLIED NODE"},"n-cairo":{country:"EGYPT",pop:"10.08M",status:"MONITORED"},"n-berlin":{country:"GERMANY",pop:"3.66M",status:"ALLIED NODE"},"n-mumbai":{country:"INDIA",pop:"20.67M",status:"MONITORED"},"n-toronto":{country:"CANADA",pop:"2.93M",status:"ALLIED NODE"},"n-singapore":{country:"SINGAPORE",pop:"5.45M",status:"NEUTRAL ZONE"},"n-nairobi":{country:"KENYA",pop:"4.40M",status:"MONITORED"},"n-istanbul":{country:"TURKEY",pop:"15.46M",status:"NEUTRAL ZONE"},"n-lagos":{country:"NIGERIA",pop:"14.86M",status:"MONITORED"}};function H_(i){let e=i.split("").reduce((c,l)=>c*31+l.charCodeAt(0)>>>0,7);const t=()=>(e=e*1664525+1013904223>>>0,(e>>>16)/65535),n=9,s=140,r=34,a=s/n;let o=`<svg viewBox="0 0 ${s} ${r}" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block;height:34px;">`;o+='<g fill="currentColor">';for(let c=0;c<n;c++){const l=8+t()*24,d=a*(.48+t()*.44),h=c*a+(a-d)*.5;o+=`<rect x="${h.toFixed(1)}" y="${(r-l).toFixed(1)}" width="${d.toFixed(1)}" height="${l.toFixed(1)}"/>`}return o+="</g></svg>",o}function Vc(i,e,t){t.dispatchEvent(new CustomEvent("s9:alert",{bubbles:!0,detail:{level:e>=70?"critical":"warning",source:i}}))}function kc(i,e){to(Ye,{...i,level:e}),lt.set(i.id,e),ts(Hi,{timestamp:new Date().toISOString(),source:"NET",message:`NODE ONLINE: ${i.label} — LVL ${e}`,alert:e>=70}),e>=70&&(Vc(i.label,e,Ye),gn(Ye,i.id),oi(Ye,i.id))}const os=un.slice(0,8),so=[15,72,55,18,28,10,45,33];os.forEach((i,e)=>{setTimeout(()=>{kc(i,so[e]),e===os.length-1&&setTimeout(()=>An(Ye,55),800)},e*300+500)});function Wc(){const i=[...lt.keys()],e=un.filter(n=>!lt.has(n.id)),t=Math.random();if(t<.28&&e.length>0){const n=e[ot(0,e.length-1)],s=ot(5,65);kc(n,s),Ce(Te,`SIGNAL ACQUIRED: ${n.label}`,"sys")}else if(t<.42&&i.length>5){const n=i[ot(0,i.length-1)],s=un.find(r=>r.id===n);Uc(Ye,n),lt.delete(n),Ce(Te,`SIGNAL LOST: ${(s==null?void 0:s.label)??n}`,"info"),ts(Hi,{timestamp:new Date().toISOString(),source:"NET",message:`NODE OFFLINE: ${(s==null?void 0:s.label)??n}`,alert:!1})}else if(t<.72&&i.length>0){const n=i[ot(0,i.length-1)],s=un.find(d=>d.id===n),r=lt.get(n)??0,a=ot(8,28),o=Math.min(100,r+a);lr(Ye,n,o),lt.set(n,o),An(Ye,Math.max(...lt.values())),Ce(Te,`THREAT ESCALATION: ${(s==null?void 0:s.label)??n} ${r}→${o}`,o>=70?"err":"sys"),ts(Hi,{timestamp:new Date().toISOString(),source:"CRIT",message:`THREAT UP: ${(s==null?void 0:s.label)??n} LVL=${o}`,alert:o>=70}),o>=70&&r<70&&(Vc((s==null?void 0:s.label)??n,o,Ye),gn(Ye,n),oi(Ye,n));const c=r>=70?2:r>=40?1:0,l=o>=70?2:o>=40?1:0;c!==l&&Ol(Ye,n)}else if(i.length>0){const n=i[ot(0,i.length-1)],s=un.find(l=>l.id===n),r=lt.get(n)??50,a=Math.max(0,r-ot(5,18));lr(Ye,n,a),lt.set(n,a),An(Ye,Math.max(0,...lt.values())),Ce(Te,`THREAT REDUCED: ${(s==null?void 0:s.label)??n} LVL=${a}`,"info");const o=r>=70?2:r>=40?1:0,c=a>=70?2:a>=40?1:0;o!==c&&Ol(Ye,n)}if(i.length>=2){const n=1+Math.floor(Math.random()*3);for(let s=0;s<n;s++){const r=i[Math.floor(Math.random()*i.length)];let a=i[Math.floor(Math.random()*i.length)];a===r&&(a=i[(i.indexOf(r)+1)%i.length]),a!==r&&Oc(Ye,r,a)}}setTimeout(Wc,ot(4e3,9e3))}setTimeout(Wc,os.length*300+2500);setInterval(()=>{const i=[...lt.keys()];if(i.length<2)return;const e=Math.random()<.4?2:1;for(let t=0;t<e;t++){const n=i[Math.floor(Math.random()*i.length)];let s=i[Math.floor(Math.random()*i.length)];s===n&&(s=i[(i.indexOf(n)+1)%i.length]),s!==n&&Oc(Ye,n,s)}},1200);setInterval(()=>{const i=[...lt.entries()].filter(([,r])=>r>=70);if(i.length===0)return;const e=Ye.getAttribute("data-active-node"),t=i.filter(([r])=>r!==e),n=t.length>0?t:i,[s]=n[Math.floor(Math.random()*n.length)];gn(Ye,s),oi(Ye,s)},8e3);const G_=document.getElementById("alert-host");document.addEventListener("s9:alert",i=>{var e;if(((e=i.detail)==null?void 0:e.level)==="critical"){const t=i.detail.source??"UNKNOWN";Ce(Te,`⚠ CRITICAL ALERT: ${t}`,"err"),ru(G_,{level:"critical",code:"CRITICAL THREAT",message:t})}});const es=document.getElementById("node-popup"),V_=document.getElementById("np-city"),k_=document.getElementById("np-skyline"),W_=document.getElementById("np-country"),X_=document.getElementById("np-pop"),q_=document.getElementById("np-coords"),Yl=document.getElementById("np-threat"),Y_=document.getElementById("np-status");Ye.addEventListener("s9:threatmap-node-select",i=>{const{nodeId:e,label:t,level:n,lat:s,lng:r}=i.detail;Ce(Te,`NODE SELECT: ${t} — LEVEL ${n} — ${s.toFixed(2)}°, ${r.toFixed(2)}°`,n>=71?"err":n>=41?"warn":"info"),ts(Hi,{timestamp:new Date().toISOString(),source:"TGT",message:`TARGET LOCKED: ${t} THREAT=${n}`,alert:n>=41});const a=z_[e]??{country:"—",pop:"—",status:"UNKNOWN"};V_.textContent=t,k_.innerHTML=H_(e),W_.textContent=a.country,X_.textContent=a.pop,q_.textContent=`${s.toFixed(2)}°, ${r.toFixed(2)}°`;const o=n>=70?"CRITICAL":n>=40?"ELEVATED":"LOW";Yl.textContent=`${n} — ${o}`,Yl.style.color=n>=70?"var(--text-alert)":n>=40?"var(--neon-amber)":"var(--neon-green)",Y_.textContent=a.status,es.classList.toggle("node-popup--left",r>60),es.setAttribute("aria-hidden","false"),es.classList.add("node-popup--visible")});Ye.addEventListener("s9:threatmap-node-deselect",()=>{es.classList.remove("node-popup--visible"),setTimeout(()=>es.setAttribute("aria-hidden","true"),260)});function $_(){const i=document.getElementById("threatmap-tactical");Nc(i,{autoRotate:!0,bloomStrength:.7});const e=new Map;os.forEach((u,f)=>{setTimeout(()=>{to(i,{...u,level:so[f]}),e.set(u.id,so[f])},f*200+300)}),setTimeout(()=>An(i,55),os.length*200+800);const t=document.getElementById("tact-node-info"),n=document.getElementById("tact-btn-add"),s=document.getElementById("tact-btn-remove"),r=document.getElementById("tact-btn-focus"),a=document.getElementById("tact-btn-deselect"),o=document.getElementById("tact-level-slider"),c=document.getElementById("tact-level-val"),l=document.getElementById("tact-level-row");let d=null;function h(){const u=d!==null&&e.has(d);if(s.disabled=!u,r.disabled=!u,a.disabled=!u,o.disabled=!u,l.style.opacity=u?"1":"0.4",l.style.pointerEvents=u?"auto":"none",u){const f=un.find(M=>M.id===d),g=e.get(d);t.textContent=`${(f==null?void 0:f.label)??d} — LVL ${g}`,o.value=g,c.textContent=g}else t.textContent="NO NODE SELECTED"}i.addEventListener("s9:threatmap-node-select",u=>{d=u.detail.nodeId,document.getElementById("tactical-threat").textContent=`THREAT: ${u.detail.level} — ${u.detail.label}`,h()}),i.addEventListener("s9:threatmap-node-deselect",()=>{d=null,h()}),n.addEventListener("click",()=>{const u=un.filter(M=>!e.has(M.id));if(u.length===0)return;const f=u[Math.floor(Math.random()*u.length)],g=Math.floor(Math.random()*60)+10;to(i,{...f,level:g}),e.set(f.id,g),An(i,Math.max(...e.values())),gn(i,f.id),oi(i,f.id)}),s.addEventListener("click",()=>{d&&(Uc(i,d),e.delete(d),An(i,e.size>0?Math.max(...e.values()):0),d=null,h())}),r.addEventListener("click",()=>{d&&oi(i,d)}),a.addEventListener("click",()=>{gn(i,null),d=null,h()}),o.addEventListener("input",()=>{if(!d)return;const u=parseInt(o.value);c.textContent=u,lr(i,d,u),e.set(d,u),An(i,Math.max(...e.values()));const f=un.find(g=>g.id===d);t.textContent=`${(f==null?void 0:f.label)??d} — LVL ${u}`}),h()}function K_(){const i=document.getElementById("flow-matrix");if(!i)return;const e=[{id:"sec9",label:"SEC.9 HQ",x:50,y:50,root:!0},{id:"niihama",label:"NIIHAMA",x:22,y:22},{id:"togusa",label:"TOGUSA",x:78,y:22},{id:"batou",label:"BATOU",x:78,y:78},{id:"ishikawa",label:"ISHIKAWA",x:22,y:78},{id:"relay1",label:"RELAY ALPHA",x:36,y:32},{id:"relay2",label:"RELAY BETA",x:64,y:32},{id:"relay3",label:"RELAY GAMMA",x:36,y:68},{id:"relay4",label:"RELAY DELTA",x:64,y:68},{id:"ext1",label:"PUPPET MASTER",x:12,y:50},{id:"ext2",label:"LAUGHING MAN",x:88,y:50},{id:"tachi",label:"TACHIKOMA U9",x:50,y:12}],t=[{id:"e01",from:"sec9",to:"relay1"},{id:"e02",from:"sec9",to:"relay2"},{id:"e03",from:"sec9",to:"relay3"},{id:"e04",from:"sec9",to:"relay4"},{id:"e05",from:"relay1",to:"niihama"},{id:"e06",from:"relay2",to:"togusa"},{id:"e07",from:"relay3",to:"ishikawa"},{id:"e08",from:"relay4",to:"batou"},{id:"e09",from:"niihama",to:"ext1"},{id:"e10",from:"ext1",to:"relay3"},{id:"e11",from:"togusa",to:"relay1"},{id:"e12",from:"batou",to:"relay2"},{id:"e13",from:"ext2",to:"relay2"},{id:"e14",from:"ext2",to:"relay4"},{id:"e15",from:"sec9",to:"tachi"},{id:"e16",from:"relay1",to:"relay2"},{id:"e17",from:"relay3",to:"relay4"}],n={relay2:72,relay4:88,ext1:95,ext2:80,niihama:45,batou:55};au(i,{nodes:e,edges:t});for(const[o,c]of Object.entries(n)){const l=i.querySelector(`[data-node-id="${o}"]`);l&&(c>=70?l.classList.add("s9-matrix__node--threat-high"):c>=40&&l.classList.add("s9-matrix__node--threat-mid"))}Vs(i,"ext1");const s=t.map(o=>o.id),r=new Set;function a(){if(r.size>0){const h=[...r],u=h[Math.floor(Math.random()*h.length)];Zl(i,u),r.delete(u)}const o=[null,null,"var(--neon-amber)","var(--neon-magenta)","var(--neon-green)",null],c=s.filter(h=>!r.has(h)),l=Math.random()<.4?2:1;for(let h=0;h<l&&c.length>0;h++){const u=c.splice(Math.floor(Math.random()*c.length),1)[0],f=o[Math.floor(Math.random()*o.length)];la(i,u,f),r.add(u)}if(Math.random()<.35){const h=e[Math.floor(Math.random()*e.length)];ou(i,h.id)}const d=document.getElementById("flow-overlay");if(d){const h=Object.values(n).filter(g=>g>=70).length,u=Object.values(n).filter(g=>g>=40&&g<70).length,f=getComputedStyle(document.documentElement).getPropertyValue("--neon-cyan").trim()||"#00d4b0";d.innerHTML=`<span style="font-family:var(--font-terminal);font-size:0.5rem;color:${f};opacity:0.7">NODES: ${e.length} &nbsp; <span style="color:var(--text-alert)">CRIT: ${h}</span> &nbsp; <span style="color:var(--neon-amber)">WARN: ${u}</span></span>`}}for(let o=0;o<4;o++){const c=s[Math.floor(Math.random()*s.length)];r.has(c)||(la(i,c),r.add(c))}setInterval(a,700),a(),document.getElementById("matrix-status").textContent="● LIVE"}
